...
export default function NewReleased() {
    ...
    const maxRows = Math.ceil(newReleasedGamesData.length / 5);
        ...
        <div className="min-h-screen font-sans overflow-x-hidden overflow-y-auto" style={{background: 'linear-gradient(135deg, #3A7A7A 0%, #102425 100%)'}}>
            <div className="max-w-7xl mx-auto px-6 md:px-12 pb-2">
                ...
                <div className="flex justify-between items-center pt-8">
                    <div>
                        <div className="flex items-center gap-2 text-xs text-white/80 mb-2">
                            ...
                            <span className="text-[#96EDD6]">New Released</span>
                        </div>
                        <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">New Released</h1>
                        <p className="text-white/80 text-base mb-2 mt-20">Your next favorite might be here.</p>
                    </div>
                ...
                <div className="grid grid-cols-5 gap-8 mb-8">
                    {newReleasedGamesData.slice(0, visibleRows * 5).map((game, idx) => (
                        <div
                            key={idx}
